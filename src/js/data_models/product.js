...
/* ModifierExtraSingle *********************/
var ModifierExtraSingleDM = newClass({
	__class__: 'ModifierExtraSingleDM',
	init: function(data){		
		this.superCall('CollectionableDM','init',data);
	},
	...
	unNormalize: function(){
		var my_clone = clone(this,true);
		// delete(my_clone.collector);
		delete(my_clone.__class__);delete(my_clone.$$hashKey);
...
var ModifierExtraSinglesDM = newClass({
	__class__: 'ModifierExtraSinglesDM',
	__elemClass__:'ModifierExtraSingleDM',
	init: function(data){
		this.superCall('CollectionDM','init',data);
	},
},'CollectionDM');
...
var ProductsDM = newClass({
	__class__: 'ProductsDM',
	__elemClass__: {single:'SingleDM',pack:'PackDM'},
	init: function(options){
		this.superCall('MultiCollectionDM','init');
